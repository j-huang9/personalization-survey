...
if st.session_state.page == 1:
    ...
    ### Risks  
    - Please note that you are completing this at your own risk; some ads may feel uncomfortably personal because they are generated using your details.  
...
# page 2: participant info
    ...
    with st.form("participant_info_form"):
        ...
        purchase_intent = st.text_input(
            "Optional: Are you currently looking to purchase anything online? If so, what? (Examples: car, plants, furniture, etc.)"
        )
